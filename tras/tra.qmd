title: "Guía de Transformaciones Rígidas en el Plano"
format: pdf
jupyter: python3
---
...
1. $T(\mathbf{u} + \mathbf{v}) = T(\mathbf{u}) + T(\mathbf{v})$ (preserva la suma de vectores)
2. $T(c \mathbf{u}) = c T(\mathbf{u})$ (preserva la multiplicación por un escalar)
...
Para un ejemplo de una transformación lineal con un núcleo de dimensión mayor o igual a uno, podemos usar una transformación de proyección. Esta proyección envía ciertos vectores al vector cero, lo que garantiza que el núcleo tiene al menos una dimensión mayor o igual a uno.
