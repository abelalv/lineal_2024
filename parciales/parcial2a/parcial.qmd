...
$$W=\bigg\{ \begin{pmatrix} x \\ y \\ z \end{pmatrix} \in R^3 : x + y + z = 0 \bigg\}$$
  ...
  + Los vectores $\vec{v} = \begin{pmatrix} 1 \\ 1 \\ -2 \end{pmatrix}$ y $\vec{w} = \begin{pmatrix} 1 \\ -2 \\ 1 \end{pmatrix}$ están en $W$? Justifique su respuesta.
...
+ Muestre que las columnas de $A$ son linealmente independientes.

+ ¿Por qué las columnas de $A$ forman una base para $R^3$?

+ Si tengo el sistema de

$$A\vec{x} = \begin{pmatrix} 1 \\ 2 \\ 3 \end{pmatrix}$$
...
$$
$$
P_2 = (2, 2.5): \ \text{a una distancia de 2 metros, la altura del agua es 2.5 metros.}
$$
$$
P_3 = (3, 3): \ \text{a una distancia de 3 metros, la altura del agua es 3 metros.}
$$
